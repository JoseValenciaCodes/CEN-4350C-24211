/** Card component meant to show an product overview*/
        ...
        <div className={`${cardTypeClass} ${bgColorClass} p-4 rounded-lg shadow-lg`}>
            ...
            </Link>
            {
                courseLevel == "beginner" && (
                    <span className="badge badge-success relative bottom-0 left-20 text-white text-sm font-semibold">Beginner</span>
                )
            }
            {
                courseLevel == "intermediate" && (
                    <span className="badge badge-warning relative bottom-0 left-20 text-white text-sm font-semibold">Intermediate</span>
                )
            }
            {
                courseLevel == "advanced" && (
                    <span className="badge badge-info relative bottom-0 left-20 text-white text-sm font-semibold">Advanced</span>
                )
            }
        </div>
    )
